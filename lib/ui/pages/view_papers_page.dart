...
class _ViewPapersPageState extends State<ViewPapersPage> {
  ...
  // Helper to open a related file (ms, qp, or gt) based on current selection
                                ...
                                if (subject != null)
                                  _buildPillDropdown(
                                    ...
                                    onChanged: (val) {
                                      setState(() {
                                        series = val;
                                        // Check if existing year/type/paper are still valid for this series
                                ...
                                if (series != null)
                                  _buildPillDropdown(
                                    ...
                                    onChanged: (val) {
                                      setState(() {
                                        year = val;
                                        // Check if existing type is still valid
                                    ...
                                    onChanged: (val) {
                                      setState(() {
                                        ...
                                        if (type == "gt") {
                                          ...
                                          // Check if this paper exists for the new type
                                          var validPapers =
