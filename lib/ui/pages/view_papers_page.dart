...
class _ViewPapersPageState extends State<ViewPapersPage> {
        ...
        builder: (context, constraints) {
          return SingleChildScrollView(
            ...
            child: ConstrainedBox(
              constraints: BoxConstraints(minHeight: constraints.maxHeight - 40), // Subtracting padding
              child: Column(
                mainAxisAlignment: MainAxisAlignment.spaceBetween, // This pushes the footer down
                children: [
                  // --- TOP SECTION: ALL YOUR CARDS ---
                  Column(
                    children: [
                      _sectionCard(
                        title: "Filter Papers",
                      ...
                      _sectionCard(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            // Replace the old GestureDetector / _statItem for the folder with this:
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.end, // Aligns to the right of the card
                              children: [
                                ...
                                InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: Colors.blueAccent.withAlpha(25), // Very subtle blue tint
                                      borderRadius: BorderRadius.circular(8),
  ...
  // --- Reusable UI Elements to match rest of code ---
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            ...
            decoration: isPath ? TextDecoration.underline : TextDecoration.none, // Adds a link look
          )
        ),
      ],
    );
  ...
  Widget _buildPillDropdown({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(30), // Increased for rounded look
